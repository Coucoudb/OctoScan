...
fn draw_help_popup(f: &mut Frame, area: Rect) {
    ...
    let help_text = vec![
        ...
        Line::from(""),
        Line::from(" CLI Usage:"),
        Line::from("   octoscan scan -t <target> -s nmap,nuclei,zap,hydra"),
        ...
        Line::from("   i          Install missing tools"),
        ...
        Line::from("   feroxbuster Directory & content discovery"),
        Line::from("   subfinder   Subdomain enumeration"),
        Line::from("   httpx       HTTP probing & tech detection"),
        Line::from("   wpscan      WordPress vulnerability scanner"),
        Line::from("   sqlmap      SQL injection (auto after ZAP/Nuclei)"),
        Line::from("   hydra       Credential brute-force (auto after Nmap)"),
        Line::from(""),
        Line::from(Span::styled(
            " Press h to close",
            Style::default().fg(Color::DarkGray),
